...
namespace Visitor
{
     class Program
    {
        ...
        {
            Manager ferit = new Manager { Name = "Ferit", Salary = 1000 };
            Manager seyma = new Manager { Name = "Şeyma", Salary = 900 };

            Worker ali = new Worker { Name= "Ali", Salary=800};
            Worker tahir = new Worker { Name = "Tahir", Salary = 800 };

            ferit.Subordinates.Add(seyma);
            seyma.Subordinates.Add(ali);
            seyma.Subordinates.Add(tahir);
            OrganisationalStructure organisationalStructure = new OrganisationalStructure(ferit);
